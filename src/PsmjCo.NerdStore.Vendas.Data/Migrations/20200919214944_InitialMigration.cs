        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DataUtilizacao = table.Column<DateTime>(type: "datetime", nullable: true),
                    DataValidade = table.Column<DateTime>(type: "datetime", nullable: false),
                    Percentual = table.Column<decimal>(type: "decimal", nullable: true),
                    TipoDescontoVoucher = table.Column<int>(type: "int", nullable: false),
                    Utilizado = table.Column<bool>(type: "bit", nullable: false),
                    ValorDesconto = table.Column<decimal>(type: "decimal", nullable: true)
                },
                constraints: table =>
                {
